...
address: "Woliso Campus"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "8.5507"       # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "37.97865"    # decimal longitude of the workshop venue (use https://www.latlong.net)
...
helper: ["TZ", "KA"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["leyk.get@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
